...
const PATTERNS: Pattern[] = [
  {
    id: "a",
    label: "Phase 1",
    title: "（〜6月末）｜Web版本番リリース",
    description: "α版で基本応答を提供しFBは随時反映、6/30に本番リリース",
    accent: "#5DCAA5",
    badgeBg: "#E1F5EE",
    badgeText: "#085041",
    dotColor: "#1D9E75",
    scope: [
      "α版(6/22)：FAQ 45件 + 用語辞典212語 + 会員サイトコンテンツ（基本応答）",
      "本番(6/30)：予測提案機能 + 会員サイトリンク表示 + 動画トランスクリプト充実",
      "α版リリース後はFBを随時反映（本番リリースを待たない）",
    ],
    duration: "2ヶ月（〜6月末）",
  ...
  },
  {
    id: "b",
    label: "Phase 2",
    title: "（〜8月中旬）｜LINE版リリース",
    description: "Web版本番リリース後、LINEで会員が実際に使える状態まで",
    accent: "#85B7EB",
    badgeBg: "#E6F1FB",
    badgeText: "#0C447C",
    dotColor: "#378ADD",
